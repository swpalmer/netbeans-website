...
Apache NetBeans can be link:/download/nb110/nb110.html[installed] on all operating systems that support Java, i.e, Windows, Linux, macOS and BSD. Write Once, Run Anywhere, applies to NetBeans too. 
